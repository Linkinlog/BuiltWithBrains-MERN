		...
		<Fragment>
				...
				<div className='row mt-2'>
					<div className='col-md-4 offset-md-4 mb-5'>
						<h4 className='text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam atque asperiores tempora, sit at neque facilis cum inventore ducimus molestiae aliquid natus sunt ut sapiente, autem est error quam illo!</h4>
					</div>
					<div className='mt-3 col-md-8 offset-md-2 p-0'>
